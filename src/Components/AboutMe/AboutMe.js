        ...
        <Fade bottom cascade>
          <Row>
            ...
            <Col xs={12} md={8}>
              <p style={{ textAlign: 'justify' }}>
                ...
                enjoy reading books, arts and gardening. Lastly, I like to
                code.🌭 This is my hobby.😍
              </p>
            </Col>
          </Row>
          <hr />
          <Row>
            ...
            <Col xs={12} md={8}>
              ...
              <p>
                ...
                <ul>&diams; Admission Year: 2021</ul>
              </p>
            </Col>
          </Row>
          <hr />
          <Row>
            <Col xs={12} md={4}>
              <Roll>
                <h4>
                  <i className="fas fa-anchor"></i> Skills
                </h4>
              </Roll>
            </Col>
            <Col xs={12} md={8}>
          ...
          <Row>
            <Col xs={12} md={4}>
              <Roll>
                <h4>
                  <i className="fas fa-tram"></i> Training
                </h4>
              </Roll>
            </Col>
            <Col xs={12} md={8}>
              <div className="d-flex justify-content-between">
                <ol>
                  <p>
                    <b>1. Complete Web Development Course</b>/ Programming Hero
                  </p>
                </ol>
              ...
              <div className="d-flex justify-content-between">
                <ol>
                  <p>
                    <b>2. Computer Office Application</b>/ Basic Computer
                    Training Academy
                  </p>
                </ol>
