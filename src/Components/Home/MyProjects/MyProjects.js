          ...
          >
            <SwiperSlide>
              <Card.Img
                ...
                src="https://i.ibb.co/Q89GmBY/Screenshot-1.png"
              />
              <Card.Body>
                <Card.Title>
                  <h5 className="fw-bold text-danger">
                    Miniature Things Related - Find Your Baby Toy
                  </h5>
                </Card.Title>
                <Card.Text>
            ...
            <SwiperSlide>
              <Card.Img
                variant="top"
                className="w-100 img-fluid"
                src="https://i.ibb.co/gM0VRVc/travele2.png"
              />
              <Card.Body>
                <Card.Title>
                  <h5 className="fw-bold text-danger">
                    Tourism Related - Travel to places in Bangladesh
                  </h5>
                </Card.Title>
                <Card.Text>
                  <div className="text-center pb-5">
            ...
            <SwiperSlide>
              <Card.Img
                variant="top"
                className="w-100 img-fluid"
                src="https://i.ibb.co/yghmGyt/hello.png"
              />
              <Card.Body>
                <Card.Title>
                  <h5 className="fw-bold text-danger">
                    VU University - Bangladesh (Task)
                  </h5>
                </Card.Title>
                <Card.Text>
                  <div className="text-center pb-5">
